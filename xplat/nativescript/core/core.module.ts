...
import {
  ...
  PlatformWindowToken
} from '@study-group/core';
import { throwIfAlreadyLoaded } from '@study-group/utils';
...
export class StudyGroupCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: StudyGroupCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'StudyGroupCoreModule');
  }
}
